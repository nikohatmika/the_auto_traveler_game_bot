...
func Handler(res http.ResponseWriter, req *http.Request) {
	...
	if !strings.Contains(strings.ToLower(body.Message.Text), "hai") {
		return
	}
...
func sayPolo(chatID int64) error {
	...
	res, err := http.Post(`https://api.telegram.org/bot1951910918:AAFxydG10KOV-35E48M4sYZT9w08qvoG_HY/sendMessage`, "application/json", bytes.NewBuffer(reqBytes))
	if err != nil {
		return err
	}
